...
namespace DesignPatternSamples.WebAPI
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseDetranVerificadorMultasFactory();
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        {
            return services
                .AddTransient<IDetranVerificadorMultasService, DetranVerificadorMultasServices>()
                ...
                .AddSingleton<IDetranVerificadorMultasFactory, DetranVerificadorMultasFactory>()
                .AddTransient<DetranPEVerificadorDebitosRepository>()
                .AddTransient<DetranPEVerificadorMultasRepository>()
                .AddTransient<DetranSPVerificadorDebitosRepository>()
                .AddTransient<DetranSPVerificadorMultasRepository>()
                .AddTransient<DetranRJVerificadorDebitosRepository>()
                .AddTransient<DetranRJVerificadorMultasRepository>()
                .AddTransient<DetranRSVerificadorDebitosRepository>()
                .AddTransient<DetranRSVerificadorMultasRepository>()
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        public static IApplicationBuilder UseDetranVerificadorMultasFactory(this IApplicationBuilder app)
        {
            app.ApplicationServices.GetService<IDetranVerificadorMultasFactory>()
                .Register("PE", typeof(DetranPEVerificadorMultasRepository))
                .Register("RJ", typeof(DetranRJVerificadorMultasRepository))
                .Register("SP", typeof(DetranSPVerificadorMultasRepository))
                .Register("RS", typeof(DetranRSVerificadorMultasRepository));
