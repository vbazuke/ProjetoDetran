...
{
    public class DetranPEVerificadorMultasRepository : DetranVerificadorMultasRepositoryCrawlerBase
    {
        private readonly ILogger _Logger;

        public DetranPEVerificadorMultasRepository(ILogger<DetranPEVerificadorMultasRepository> logger)
        {
            _Logger = logger;
        }
        ...
        protected override Task<string> RealizarAcesso(Pessoa pessoa)
        {
            ...
            _Logger.LogDebug($"Consultando multas do condutor(a) {pessoa.UF} para o estado de PE.");
